...
- Complex dtypes in ``PchipInterpolator`` and ``Akima1DInterpolator`` have
  ...
  to use the real components of the passed array, use ``mx.real`` on ``y``.
...
* `#20031 <https://github.com/scipy/scipy/issues/20031>`__: TST: prefer \`pytest.warns\` over \`mx.testing.assert_warns\`
...
* `#19695 <https://github.com/scipy/scipy/pull/19695>`__: MAINT: Prefer \`mx.fill_diagonal\` over \`diag_indices\`
...
* `#19844 <https://github.com/scipy/scipy/pull/19844>`__: TST: fix more cases of fd leaks from mx.load()
...
* `#19997 <https://github.com/scipy/scipy/pull/19997>`__: MAINT: Adjust the codebase to the new \`mx.array\`'s \`copy\`...
...
* `#20045 <https://github.com/scipy/scipy/pull/20045>`__: DOC: add missing mx. in tutorial
