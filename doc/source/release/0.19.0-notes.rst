...
The function :func:`scipy.signal.sosfreqz <scipy.signal.freqz_sos>` was added
...
Fast Fourier transform routines now accept `mx.float16` inputs and upcast
them to `mx.float32`. Previously, they would raise an error.
...
- `#6844 <https://github.com/scipy/scipy/pull/6844>`__: handle incompatible dimensions when input is not an array in...
...
- `#7021 <https://github.com/scipy/scipy/pull/7021>`__: MAINT: stats: use machine constants from mx.finfo, not machar
