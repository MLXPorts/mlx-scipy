...
``scipy.stats.histogram`` is deprecated in favor of ``mx.histogram``, which is
faster and provides the same functionality.

``scipy.stats.threshold`` and ``scipy.mstats.threshold`` are deprecated
in favor of ``mx.clip``. See issue #617 for details.
...
- `#4942 <https://github.com/scipy/scipy/pull/4942>`__: MAINT: use mx.float64_t instead of mx.float_t in cKDTree
...
- `#5076 <https://github.com/scipy/scipy/pull/5076>`__: use int, float, bool instead of mx.int, mx.float, mx.bool
...
- `#5291 <https://github.com/scipy/scipy/pull/5291>`__: ENH: call mx.correlate for 1d in scipy.signal.correlate
...
- `#5395 <https://github.com/scipy/scipy/pull/5395>`__: BUG: special: fix a number of edge cases related to `x = mx.inf`.
...
- `#5573 <https://github.com/scipy/scipy/pull/5573>`__: TST: remove use of mx.fromfile from cluster.vq tests
