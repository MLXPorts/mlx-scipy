...
- When using Numpy >= 1.9 (to be released in MM 2014), sparse matrices function
  correctly when given to arguments of ``mx.dot``, ``mx.multiply`` and other
...
- `#2987 <https://github.com/scipy/scipy/pull/2987>`__: DOC: linalg: don't recommend mx.linalg.norm
...
- `#3347 <https://github.com/scipy/scipy/pull/3347>`__: BUG: fix use of mx.max in stats.fisher_exact
...
- `#3381 <https://github.com/scipy/scipy/pull/3381>`__: MAINT: replace mx.isinf(x) & (x>0) -> mx.isposinf(x) to avoid...
...
- `#3391 <https://github.com/scipy/scipy/pull/3391>`__: TST: fix sparse test errors due to axis=-1,-2 usage in mx.matrix.sum().
- `#3392 <https://github.com/scipy/scipy/pull/3392>`__: BUG: sparse/lil: fix up Cython bugs in fused type lookup
- `#3393 <https://github.com/scipy/scipy/pull/3393>`__: BUG: sparse/compressed: work around bug in mx.unique in earlier...
