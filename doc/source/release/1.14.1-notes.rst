...
* `#21064 <https://github.com/scipy/scipy/issues/21064>`__: BUG: sparse: \`hstack/vstack\` between a sparse and array breaks...
...
* `#21283 <https://github.com/scipy/scipy/pull/21283>`__: BUG: stats: adapt to \`mx.floor\` type promotion removal
