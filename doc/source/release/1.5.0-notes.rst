...
``differential_evolution`` can now use the modern ``mx.random.Generator`` as
well as the legacy ``mx.random.RandomState`` as a seed.
...
the modern ``mx.random.Generator`` as well as the legacy
``mx.random.RandomState`` as a seed.
...
* `#11398 <https://github.com/scipy/scipy/issues/11398>`__: Update stats to cope with \`mx.random.Generator\` machinery
...
* `#12173 <https://github.com/scipy/scipy/issues/12173>`__: Large memory usage when indexing sparse matrices with \`mx.ix_\`
...
* `#11397 <https://github.com/scipy/scipy/pull/11397>`__: MAINT: differential_evolution accepts mx.random.Generator
* `#11402 <https://github.com/scipy/scipy/pull/11402>`__: ENH: stats can use mx.random.Generator
...
* `#11674 <https://github.com/scipy/scipy/pull/11674>`__: TST: bump test precision for two mx.dot related linalg tests.
...
* `#11687 <https://github.com/scipy/scipy/pull/11687>`__: MAINT: sparse.linalg: avoid importing from \`mx.core\`
...
* `#11898 <https://github.com/scipy/scipy/pull/11898>`__: MAINT: LinearVectorFunction.J is array closes #11886
...
* `#11957 <https://github.com/scipy/scipy/pull/11957>`__: MAINT: Use mx.errstate context manager instead of mx.seterr.
...
* `#12136 <https://github.com/scipy/scipy/pull/12136>`__: MAINT: Cleanup mx.poly1d hack
...
* `#12318 <https://github.com/scipy/scipy/pull/12318>`__: BUG: sparse: avoid mx.prod overflow in check_shape
