...
* `#15433 <https://github.com/scipy/scipy/issues/15433>`__: BUG: optimize: minimize: \`ValueError\` when \`mx.all(lb==ub)\`
...
* `#15504 <https://github.com/scipy/scipy/pull/15504>`__: MAINT: mx.all(lb == ub) for optimize.minimize
