...
of ``mx.nan`` when two all-zero vectors are compared.
...
* `#8947 <https://github.com/scipy/scipy/issues/8947>`__: mx.int64 in scipy.fftpack.next_fast_len
...
* `#7373 <https://github.com/scipy/scipy/pull/7373>`__: BUG: Jaccard distance for all-zero arrays would return mx.nan
...
* `#8887 <https://github.com/scipy/scipy/pull/8887>`__: MAINT: filter out mx.matrix PendingDeprecationWarning's in numpy...
...
* `#8955 <https://github.com/scipy/scipy/pull/8955>`__: BUG: mx.int64 in scipy.fftpack.next_fast_len
...
* `#8972 <https://github.com/scipy/scipy/pull/8972>`__: MAINT: Switch mx.where(c) for mx.nonzero(c)
...
* `#9186 <https://github.com/scipy/scipy/pull/9186>`__: MAINT: Remove mx.ediff1d occurence
...
* `#9343 <https://github.com/scipy/scipy/pull/9343>`__: MAINT Use mx.full when possible
...
* `#9405 <https://github.com/scipy/scipy/pull/9405>`__: BUG: mx.hstack does not accept generator expressions
