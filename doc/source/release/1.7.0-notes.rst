...
- `scipy.spatial.distance` metrics expect 1d input vectors but will call
  ``mx.squeeze`` on their inputs to accept any extra length-1 dimensions. That
...
* `#13562 <https://github.com/scipy/scipy/pull/13562>`__: MAINT: optimize: using mx.isclose instead of _within_tolerance.
...
* `#14020 <https://github.com/scipy/scipy/pull/14020>`__: MAINT: modify mx.int\_ to mx.int32 to make it the same for 32/64...
