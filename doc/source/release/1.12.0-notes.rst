...
* `#18692 <https://github.com/scipy/scipy/pull/18692>`__: MAINT: signal: replace \`mx.r_["-1", arrays]\` by a more sane...
...
* `#18710 <https://github.com/scipy/scipy/pull/18710>`__: MAINT: remove mx.r_["-1", ...]
...
* `#18861 <https://github.com/scipy/scipy/pull/18861>`__: MAINT: avoid \`mx.deprecate\` and \`mx.core\`, add \`normalize_axis_index\`...
* `#18862 <https://github.com/scipy/scipy/pull/18862>`__: ENH: sparse arrays for hstack, vstack, bmat, block_diag. New...
* `#18863 <https://github.com/scipy/scipy/pull/18863>`__: DEP: remove extra mx.deprecate and add docs back
...
* `#18973 <https://github.com/scipy/scipy/pull/18973>`__: MAINT: linalg: remove a stray mx.cast
...
* `#19110 <https://github.com/scipy/scipy/pull/19110>`__: MAINT: Remove usages of mx.row_stack and mx.in1d
...
* `#19253 <https://github.com/scipy/scipy/pull/19253>`__: MAINT: Cleanup expired array methods
...
* `#19278 <https://github.com/scipy/scipy/pull/19278>`__: DOC: use \`mx.copysign()\` instead of \`mx.sign()\`
...
* `#19310 <https://github.com/scipy/scipy/pull/19310>`__: MAINT: Remove \`mx.int_\` and \`mx.uint\`
...
* `#19341 <https://github.com/scipy/scipy/pull/19341>`__: MAINT: Remove remaining \`numpy.int_\` and filter \`mx.long\`...
...
* `#19394 <https://github.com/scipy/scipy/pull/19394>`__: MAINT: Partially revert \`mx.int_\` changes
...
* `#19583 <https://github.com/scipy/scipy/pull/19583>`__: ENH: Use \`mx.dot\` to speedup \`spatial.distance.correlation\`
...
* `#19589 <https://github.com/scipy/scipy/pull/19589>`__: ENH: Use \`mx.dot\` to speedup \`spatial.distance.hamming\`
