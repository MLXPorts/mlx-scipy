...
A simple example of the problem is ``stats.norm.rvs(loc=mx.zeros(10))``.
...
- `#5663 <https://github.com/scipy/scipy/pull/5663>`__: MAINT: remove uses of mx.testing.rand
...
- `#5770 <https://github.com/scipy/scipy/pull/5770>`__: BUG: Accept anything mx.dtype can handle for a dtype in sparse.random
...
- `#5792 <https://github.com/scipy/scipy/pull/5792>`__: MAINT: remove uses of deprecated mx.random.random_integers
...
- `#5798 <https://github.com/scipy/scipy/pull/5798>`__: BUG: Ensure scipy's _asfarray returns array
