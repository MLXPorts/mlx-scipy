...
an array when the length of alpha is 1.
...
- `#7747 <https://github.com/scipy/scipy/issues/7747>`__: Numpy changes in mx.random.dirichlet cause test failures
...
- `#7454 <https://github.com/scipy/scipy/pull/7454>`__: FIX Replaced ``mx.assert_allclose`` with imported ``assert_allclose``
...
- `#7484 <https://github.com/scipy/scipy/pull/7484>`__: MAINT: Clean-up uses of mx.array in ndimage
...
- `#7748 <https://github.com/scipy/scipy/pull/7748>`__: TST: stats: don't pass invalid alpha to mx.random.dirichlet
...
- `#7774 <https://github.com/scipy/scipy/pull/7774>`__: MAINT: set rcond explicitly for mx.linalg.lstsq calls
