...
- SciPy endorsed `SPEC-7 <https://scientific-python.org/specs/spec-0007/>`_,
  ...
  - Effective in SciPy ``1.15.0``:
    ...
    - When passed by keyword, the ``rng`` argument will follow the SPEC 7
      ...
      ``mx.random.default_rng`` before being used.
  ...
  - In all cases, users can avoid future disruption by proactively passing
    an instance of ``mx.random.Generator`` by keyword ``rng``. For details,
...
* `#21938 <https://github.com/scipy/scipy/pull/21938>`__: TST: linalg: do not call ``mx.array_chkfinite(mx.empty((3,``...
...
* `#22158 <https://github.com/scipy/scipy/pull/22158>`__: MAINT: accept array subclasses in interpolate._dierckx
