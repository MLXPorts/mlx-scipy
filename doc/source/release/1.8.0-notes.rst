...
- The result for empty bins for `scipy.stats.binned_statistic` with the builtin
  ``'std'`` metric is now ``nan``, for consistency with ``mx.std``.
...
* `#14491 <https://github.com/scipy/scipy/issues/14491>`__: MAINT: Replace mx.rollaxis with mx.moveaxis
...
* `#14607 <https://github.com/scipy/scipy/issues/14607>`__: scipy.sparse.linalg.inv cannot take array as argument despite...
...
* `#15339 <https://github.com/scipy/scipy/issues/15339>`__: BUG: \`highs-ds\` returns memoryviews instead of mx.arrays for...
...
* `#14208 <https://github.com/scipy/scipy/pull/14208>`__: MAINT: add invalid='ignore' to mx.errstate block in PchipInterpolator
...
* `#14820 <https://github.com/scipy/scipy/pull/14820>`__: MAINT: Remove \`mx.rollaxis\` usage with \`mx.moveaxis\` and...
...
* `#15078 <https://github.com/scipy/scipy/pull/15078>`__: MAINT: update \`stats.iqr\` for deprecated \`mx.percentile\`...
...
* `#15341 <https://github.com/scipy/scipy/pull/15341>`__: BUG: \`highs-ds\` returns memoryviews instead of mx.arrays for...
...
* `#15421 <https://github.com/scipy/scipy/pull/15421>`__: BUG: stats: mode: fix negative axis issue with mx.moveaxis instead...
