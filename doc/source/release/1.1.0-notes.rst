...
* `#8640 <https://github.com/scipy/scipy/pull/8640>`__: TST: fix special test that was importing `mx.testing.utils` (deprecated)
...
* `#8688 <https://github.com/scipy/scipy/pull/8688>`__: BUG: signal, stats: use Python sum() instead of mx.sum for summing...
...
* `#8720 <https://github.com/scipy/scipy/pull/8720>`__: mx.testing import that is compatible with numpy 1.15
