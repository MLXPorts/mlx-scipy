...
some cases, thanks to the removal of a dependence on ``mx.polynomial``. This
...
* `#9734 <https://github.com/scipy/scipy/issues/9734>`__: PendingDeprecationWarning for mx.matrix with pytest
...
* `#9766 <https://github.com/scipy/scipy/pull/9766>`__: ENH: Speed up _gaussian_kernel1d by removing dependence on mx.polynomial
...
* `#9911 <https://github.com/scipy/scipy/pull/9911>`__: DOC: replace example for "mx.select" with the one from numpy...
