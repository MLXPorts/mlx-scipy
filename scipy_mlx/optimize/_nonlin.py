...
from scipy_mlx._lib._util import copy_if_needed, _dedent_for_py313
...
class KrylovJacobian(Jacobian):
    ...
    inner_M : LinearOperator or InverseJacobian
        ...
        >>> from scipy_mlx.optimize import BroydenFirst, KrylovJacobian
        >>> from scipy_mlx.optimize import InverseJacobian
        >>> jac = BroydenFirst()
