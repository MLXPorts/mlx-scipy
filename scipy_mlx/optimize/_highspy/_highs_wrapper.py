...
import scipy_mlx.optimize._highspy._core as _h # type: ignore[import-not-found]
from scipy_mlx.optimize._highspy import _highs_options as hopt  # type: ignore[attr-defined]
