...
from scipy_mlx.optimize import OptimizeResult, minimize
from scipy_mlx.optimize._constraints import (Bounds, new_bounds_to_old,
                                         NonlinearConstraint, LinearConstraint)
from scipy_mlx.optimize._optimize import _status_message, _wrap_callback
from scipy_mlx._lib._util import (check_random_state, MapWrapper, _FunctionWrapper,
...
def differential_evolution(func, bounds, args=(), strategy='best1bin',
    ...
    >>> import mlx.core as mx
    >>> from scipy_mlx.optimize import rosen, differential_evolution
    ...
    >>> from scipy_mlx.optimize import LinearConstraint, Bounds
