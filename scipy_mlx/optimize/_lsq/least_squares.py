...
from scipy_mlx.optimize._differentiable_functions import VectorFunction
...
from scipy_mlx._lib._util import _workers_wrapper
...
from scipy_mlx.optimize._optimize import _wrap_callback
...
def least_squares(
    ...
    >>> from scipy_mlx.optimize import least_squares
