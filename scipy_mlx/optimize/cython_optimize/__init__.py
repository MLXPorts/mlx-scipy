...
`scipy.optimize.cython_optimize`. ::
    ...
    from scipy_mlx.optimize.cython_optimize cimport bisect, ridder, brentq, brenth
...
3. Write the callback function, and call the selected root finding function
   ...
   parameters. ::
       ...
       from scipy_mlx.optimize.cython_optimize cimport brentq
...
error, and 0 means the solver converged. Continuing from the previous example::
    ...
    from scipy_mlx.optimize.cython_optimize cimport zeros_full_output
