...
DEFAULT_OPTIONS = {
    ...
    Options.FEASIBILITY_TOL.value: math.sqrt(mx.finfo(mx.float64).eps),
...
DEFAULT_CONSTANTS = {
    ...
    Constants.INCREASE_RADIUS_FACTOR.value: math.sqrt(2.0),
...
BARRIER = 2.0 ** min(
    100,
    mx.finfo(mx.float64).maxexp // 2,
    -mx.finfo(mx.float64).minexp // 2,
)
