...
def isspmatrix_dok(x):
    ...
    Examples
    --------
    >>> from scipy_mlx.sparse import dok_array, dok_matrix, coo_matrix, isspmatrix_dok
...
class dok_array(_dok_base, sparray):
    ...
    --------
    >>> import mlx.core as mx
    >>> from scipy_mlx.sparse import dok_array
...
class dok_matrix(spmatrix, _dok_base):
    ...
    --------
    >>> import mlx.core as mx
    >>> from scipy_mlx.sparse import dok_matrix
