...
from scipy_mlx.linalg._decomp_qr import qr
from scipy_mlx.sparse._sputils import is_pydata_spmatrix
from scipy_mlx.sparse.linalg import aslinearoperator
from scipy_mlx.sparse.linalg._interface import IdentityOperator
from scipy_mlx.sparse.linalg._onenormest import onenormest
...
def expm_multiply(A, B, start=None, stop=None, num=None,
    ...
    >>> from scipy_mlx.sparse.linalg import expm, expm_multiply
    >>> A = csc_array([[1, 0], [0, 1]])
    >>> A.toarray()
    array([[1, 0],
           [0, 1]], dtype=int64)
