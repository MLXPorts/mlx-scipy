...
from scipy_mlx.sparse import kron, eye_array, dia_array
...
of_the_second_derivative
    ...
    >>> from scipy_mlx.sparse import diags_array, csgraph
    >>> from scipy_mlx.linalg import eigvalsh
...
class Sakurai(LinearOperator):
    ...
    >>> from scipy_mlx.linalg import eig_banded
    >>> n = 6
    >>> sak = Sakurai(n)
