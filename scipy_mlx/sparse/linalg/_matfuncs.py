...
from scipy_mlx.linalg._basic import solve, solve_triangular

from scipy_mlx.sparse._base import issparse
from scipy_mlx.sparse.linalg import spsolve
from scipy_mlx.sparse._sputils import is_pydata_spmatrix, isintlike

import scipy_mlx.sparse
import scipy_mlx.sparse.linalg
from scipy_mlx.sparse.linalg._interface import LinearOperator
from scipy_mlx.sparse._construct import eye_array
...
def inv(A):
    ...
    >>> from scipy_mlx.sparse.linalg import inv
    >>> A = csc_array([[1., 0.], [1., 2.]])
    >>> Ainv = inv(A)
    >>> Ainv
...
def expm(A):
    ...
    --------
    >>> from scipy_mlx.sparse import csc_array
    >>> from scipy_mlx.sparse.linalg import expm
