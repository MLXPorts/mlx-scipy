...
def shortest_path(csgraph, method='auto',
    ...
    >>> from scipy_mlx.sparse.csgraph import shortest_path
...
def floyd_warshall(csgraph, directed=True,
    ...
    --------
    >>> from scipy_mlx.sparse import csr_array
    >>> from scipy_mlx.sparse.csgraph import floyd_warshall
...
def dijkstra(csgraph, directed=True, indices=None,
    ...
    --------
    >>> from scipy_mlx.sparse import csr_array
    >>> from scipy_mlx.sparse.csgraph import dijkstra
...
def bellman_ford(csgraph, directed=True, indices=None,
    ...
    --------
    >>> from scipy_mlx.sparse import csr_array
    >>> from scipy_mlx.sparse.csgraph import bellman_ford
...
def johnson(csgraph, directed=True, indices=None,
    ...
    --------
    >>> from scipy_mlx.sparse import csr_array
    >>> from scipy_mlx.sparse.csgraph import johnson
...
def yen(
    ...
    *,
    ...
    --------
    >>> from scipy_mlx.sparse import csr_array
    >>> from scipy_mlx.sparse.csgraph import yen
