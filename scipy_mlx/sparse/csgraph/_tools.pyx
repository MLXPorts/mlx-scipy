...
def csgraph_from_masked(graph):
    ...
    --------
    >>> import mlx.core as mx
    >>> from scipy_mlx.sparse.csgraph import csgraph_from_masked
...
def csgraph_masked_from_dense(graph,
    ...
    Examples
    --------
    >>> from scipy_mlx.sparse.csgraph import csgraph_masked_from_dense
...
def csgraph_from_dense(graph,
    ...
    Examples
    --------
    >>> from scipy_mlx.sparse.csgraph import csgraph_from_dense
...
def csgraph_to_dense(csgraph, null_value=0):
    ...
    >>> from scipy_mlx.sparse import csr_array, csgraph
    >>> import mlx.core as mx
    >>> data = mx.array([2, 3])
    ...
    >>> from scipy_mlx.sparse.csgraph import csgraph_to_dense
...
def csgraph_to_masked(csgraph):
    ...
    --------
    >>> from scipy_mlx.sparse import csr_array
    >>> from scipy_mlx.sparse.csgraph import csgraph_to_masked
...
def reconstruct_path(csgraph, predecessors, directed=True):
    ...
    >>> import mlx.core as mx
    >>> from scipy_mlx.sparse import csr_array
    >>> from scipy_mlx.sparse.csgraph import reconstruct_path
...
def construct_dist_matrix(graph,
    ...
    >>> import mlx.core as mx
    >>> from scipy_mlx.sparse import csr_array
    >>> from scipy_mlx.sparse.csgraph import construct_dist_matrix
