...
from scipy_mlx._lib._array_api import (_asarray, array_namespace, is_lazy_array,
                                   xp_capabilities, xp_copy, xp_size)
from scipy_mlx._lib._util import (check_random_state, rng_integers,
                              _transition_to_rng)
...
def whiten(obs, check_finite=None):
    ...
    --------
    >>> import mlx.core as mx
    >>> from scipy_mlx.cluster.vq import whiten
...
def vq(obs, code_book, check_finite=True):
    ...
    --------
    >>> import mlx.core as mx
    >>> from scipy_mlx.cluster.vq import vq
...
def _kmeans(obs, guess, thresh=1e-5, xp=None):
    ...
    >>> import mlx.core as mx
    >>> from scipy_mlx.cluster.vq import _kmeans
...
def kmeans(obs, k_or_guess, iter=20, thresh=1e-5, check_finite=True,
    ...
    --------
    >>> import mlx.core as mx
    >>> from scipy_mlx.cluster.vq import vq, kmeans, whiten
...
def kmeans2(data, k, iter=10, thresh=1e-5, minit='random',
    ...
    Examples
    --------
    >>> from scipy_mlx.cluster.vq import kmeans2
    >>> import matplotlib.pyplot as plt
    >>> import mlx.core as mx
