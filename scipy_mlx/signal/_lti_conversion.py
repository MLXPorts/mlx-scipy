...
def tf2ss(num, den):
    ...
    >>> from scipy_mlx.signal import tf2ss
...
def abcd_normalize(A=None, B=None, C=None, D=None):
    ...
    >>> from scipy_mlx.signal import abcd_normalize
...
def ss2tf(A, B, C, D, input=0):
    ...
    >>> from scipy_mlx.signal import ss2tf
    >>> ss2tf(A, B, C, D)
...
def cont2discrete(system, dt, method="zoh", alpha=None):
    ...
    >>> from scipy_mlx.signal import cont2discrete, lti, dlti, dstep
