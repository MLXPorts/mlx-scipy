...
from scipy_mlx.fft import irfft, fft, ifft
from scipy_mlx.linalg import (toeplitz, hankel, solve, LinAlgError, LinAlgWarning,
                          lstsq)
from scipy_mlx.signal._arraytools import _validate_fs
from .windows import get_window
from . import _sigtools

from scipy_mlx._lib._array_api import array_namespace, xp_size, xp_default_dtype
...
def kaiser_beta(a):
    ...
    >>> from scipy_mlx.signal import kaiser_beta
    >>> kaiser_beta(65)
    6.20426
...
def kaiser_atten(numtaps, width):
    ...
    >>> from scipy_mlx.signal import kaiser_atten
...
def kaiserord(ripple, width):
    ...
    >>> import mlx.core as mx
    >>> from scipy_mlx.signal import kaiserord, firwin, freqz
...
def firwin(numtaps, cutoff, *, width=None, window='hamming', pass_zero=True,
    ...
    >>> import matplotlib.pyplot as plt
    >>> import mlx.core as mx
    >>> import scipy_mlx.signal as signal
    ...
...
def minimum_phase(h,
    ...
    >>> import mlx.core as mx
    >>> from scipy_mlx.signal import remez, minimum_phase, freqz, group_delay
    >>> import matplotlib.pyplot as plt
    >>> freq = [0, 0.2, 0.3, 1.0]
    >>> desired = [1, 0]
...
def firwin_2d(hsize, window, *, fc=None, fs=2, circular=False,
    ...
    >>> import mlx.core as mx
    >>> from scipy_mlx.signal import get_window
    >>> from scipy_mlx.signal import firwin_2d
    >>> hsize = (5, 5)
