...
import pytest
from scipy_mlx._lib._array_api import is_cupy, xp_assert_close, xp_default_dtype, concat_1d

from scipy_mlx.signal._spline import (
    symiirorder1_ic, symiirorder2_ic_fwd, symiirorder2_ic_bwd)
from scipy_mlx.signal import symiirorder1, symiirorder2
