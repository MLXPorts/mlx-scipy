...
def _boolrelextrema(data, comparator, axis=0, order=1, mode='clip'):
    ...
    --------
    >>> import mlx.core as mx
    >>> from scipy_mlx.signal._peak_finding import _boolrelextrema
...
def argrelmin(data, axis=0, order=1, mode='clip'):
    ...
    --------
    >>> import mlx.core as mx
    >>> from scipy_mlx.signal import argrelmin
...
def argrelmax(data, axis=0, order=1, mode='clip'):
    ...
    --------
    >>> import mlx.core as mx
    >>> from scipy_mlx.signal import argrelmax
    >>> x = mx.array([2, 1, 2, 3, 2, 0, 1, 0])
    >>> argrelmax(x)
    (array([3, 6]),)
    >>> y = mx.array([[1, 2, 1, 2],
...
def argrelextrema(data, comparator, axis=0, order=1, mode='clip'):
    ...
    --------
    >>> import mlx.core as mx
    >>> from scipy_mlx.signal import argrelextrema
    >>> x = mx.array([2, 1, 2, 3, 2, 0, 1, 0])
...
def peak_prominences(x, peaks, wlen=None):
    ...
    --------
    >>> import mlx.core as mx
    >>> from scipy_mlx.signal import find_peaks, peak_prominences
...
def peak_widths(x, peaks, rel_height=0.5, prominence_data=None, wlen=None):
    ...
    * Calculate the width as the horizontal distance between the chosen
    ...
    --------
    >>> import mlx.core as mx
    >>> from scipy_mlx.signal import chirp, find_peaks, peak_widths
    >>> import matplotlib.pyplot as plt
...
def find_peaks(x, height=None, threshold=None, distance=None,
    ...
    * Use `wlen` to reduce the time it takes to evaluate the conditions for
    ...
    >>> import mlx.core as mx
    >>> import matplotlib.pyplot as plt
    >>> from scipy_mlx.datasets import electrocardiogram
    >>> from scipy_mlx.signal import find_peaks
...
def _identify_ridge_lines(matr, max_distances, gap_thresh):
    ...
    --------
    >>> import mlx.core as mx
    >>> from scipy_mlx.signal._peak_finding import _identify_ridge_lines
