...
def spline_filter(Iin, lmbda=5.0):
    ...
    >>> import mlx.core as mx
    >>> from scipy_mlx.signal import spline_filter
...
def gauss_spline(x, n):
    ...
    >>> import mlx.core as mx
    >>> from scipy_mlx.signal import gauss_spline
...
def cspline1d(signal, lamb=0.0):
    ...
    >>> import mlx.core as mx
    >>> import matplotlib.pyplot as plt
    >>> from scipy_mlx.signal import cspline1d, cspline1d_eval
...
def qspline1d(signal, lamb=0.0):
    ...
    >>> import mlx.core as mx
    >>> import matplotlib.pyplot as plt
    >>> from scipy_mlx.signal import qspline1d, qspline1d_eval
    >>> rng = mx.random.default_rng()
    >>> sig = mx.repeat([0., 1., 0.], 100)
    >>> sig += rng.standard_normal(len(sig))*0.05  # add noise
    >>> time = mx.linspace(0, len(sig))
