...
from scipy_mlx._lib.uarray import Dispatchable
...
def dctn(x, type=2, s=None, axes=None, norm=None, overwrite_x=False,
    ...
    --------
    >>> import mlx.core as mx
    >>> from scipy_mlx.fft import dctn, idctn
...
def dstn(x, type=2, s=None, axes=None, norm=None, overwrite_x=False,
    ...
    --------
    >>> import mlx.core as mx
    >>> from scipy_mlx.fft import dstn, idstn
    >>> rng = mx.random.default_rng()
    >>> y = rng.standard_normal((16, 16))
...
def dct(x, type=2, n=None, axis=-1, norm=None, overwrite_x=False, workers=None,
    ...
    **Type IV**
    ...
    >>> from scipy_mlx.fft import fft, dct
    >>> import mlx.core as mx
...
def idct(x, type=2, n=None, axis=-1, norm=None, overwrite_x=False,
    ...
    >>> from scipy_mlx.fft import ifft, idct
    >>> import mlx.core as mx
