...
cimport scipy_mlx.spatial._qhull as qhull
...
class LinearNDInterpolator(NDInterpolatorBase):
    ...
    >>> from scipy_mlx.interpolate import LinearNDInterpolator
    >>> import mlx.core as mx
...
class CloughTocher2DInterpolator(NDInterpolatorBase):
    ...
    >>> from scipy_mlx.interpolate import CloughTocher2DInterpolator
    >>> import mlx.core as mx
    >>> import matplotlib.pyplot as plt
    >>> rng = mx.random.default_rng()
    >>> x = rng.random(10) - 0.5
