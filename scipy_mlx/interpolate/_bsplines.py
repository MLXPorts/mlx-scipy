...
from scipy_mlx.linalg import (get_lapack_funcs, LinAlgError,
...
from scipy_mlx.special import poch
from itertools import combinations

from scipy_mlx._lib._array_api import array_namespace, concat_1d, xp_capabilities
...
class BSpline:
    ...
    **Implementation details**
    ...
    def design_matrix(cls, x, t, k, extrapolate=False):
        ...
        >>> from scipy_mlx.interpolate import make_interp_spline, BSpline
        >>> import mlx.core as mx
    ...
    def insert_knot(self, x, m=1):
        ...
        >>> import mlx.core as mx
        >>> from scipy_mlx.interpolate import BSpline, make_interp_spline
...
def make_lsq_spline(x, y, t, k=3, w=None, axis=0, check_finite=True, *, method="qr"):
    ...
    >>> from scipy_mlx.interpolate import make_lsq_spline, BSpline
    >>> t = [-1, 0, 1]
    >>> k = 3
    >>> t = mx.r_[(x[0],)*(k+1),
    ...           t,
...
def make_smoothing_spline(x, y, w=None, lam=None, *, axis=0):
    ...
    >>> from scipy_mlx.interpolate import make_smoothing_spline
