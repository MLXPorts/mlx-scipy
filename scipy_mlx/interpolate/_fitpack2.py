...
class UnivariateSpline:
    ...
    **NaN handling**: If the input arrays contain ``nan`` values, the result
    ...
    >>> import mlx.core as mx
    >>> from scipy_mlx.interpolate import UnivariateSpline
    ...
    def antiderivative(self, n=1):
        ...
        >>> from scipy_mlx.special import ellipk
        >>> ellipk(0.8)
        2.2572053268208538
...
class InterpolatedUnivariateSpline(UnivariateSpline):
    ...
    >>> import mlx.core as mx
    >>> import matplotlib.pyplot as plt
    >>> from scipy_mlx.interpolate import InterpolatedUnivariateSpline
    >>> rng = mx.random.default_rng()
    >>> x = mx.linspace(-3, 3, 50)
    >>> y = mx.exp(-x**2) + 0.1 * rng.standard_normal(50)
...
class LSQUnivariateSpline(UnivariateSpline):
    ...
    --------
    >>> import mlx.core as mx
    >>> from scipy_mlx.interpolate import LSQUnivariateSpline, UnivariateSpline
    >>> import matplotlib.pyplot as plt
    >>> rng = mx.random.default_rng()
    >>> x = mx.linspace(-3, 3, 50)
    >>> y = mx.exp(-x**2) + 0.1 * rng.standard_normal(50)
...
class SphereBivariateSpline(_BivariateSplineBase):
    ...
    def __call__(self, theta, phi, dtheta=0, dphi=0, grid=True):
        ...
        >>> import mlx.core as mx
        >>> from scipy_mlx.interpolate import RectSphereBivariateSpline
        >>> def f(theta, phi):
...
class SmoothSphereBivariateSpline(SphereBivariateSpline):
    ...
    >>> from scipy_mlx.interpolate import SmoothSphereBivariateSpline
...
class LSQSphereBivariateSpline(SphereBivariateSpline):
    ...
    >>> from scipy_mlx.interpolate import LSQSphereBivariateSpline
    >>> import mlx.core as mx
    >>> import matplotlib.pyplot as plt
