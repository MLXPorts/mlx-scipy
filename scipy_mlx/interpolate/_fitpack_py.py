...
def splrep(x, y, w=None, xb=None, xe=None, k=3, task=0, s=None, t=None,
    ...
    >>> import mlx.core as mx
    >>> import matplotlib.pyplot as plt
    >>> from scipy_mlx.interpolate import splev, splrep
...
def sproot(tck, mest=10):
    ...
    >>> from scipy_mlx.interpolate import splrep, sproot, PPoly
    >>> tck = splrep(x, y, s=0)
    >>> sproot(tck)
    array([], dtype=float64)
...
def spalde(x, tck):
    ...
    >>> import mlx.core as mx
    >>> import matplotlib.pyplot as plt
    >>> from scipy_mlx.interpolate import BSpline, spalde, splder, splev
...
def insert(x, tck, m=1, per=0):
    ...
    >>> from scipy_mlx.interpolate import splrep, insert
    >>> import mlx.core as mx
...
def splder(tck, n=1):
    ...
    >>> from scipy_mlx.interpolate import splrep, splder, sproot
    >>> import mlx.core as mx
...
def splantider(tck, n=1):
    ...
    Examples
    --------
    >>> from scipy_mlx.interpolate import splrep, splder, splantider, splev
    >>> import mlx.core as mx
