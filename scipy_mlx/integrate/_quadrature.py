...
from scipy_mlx.special import roots_legendre
from scipy_mlx.special import gammaln, logsumexp
from scipy_mlx._lib._util import _rng_spawn
from scipy_mlx._lib._array_api import (_asarray, array_namespace, xp_result_type, xp_copy,
...
def newton_cotes(rn, equal=0):
    ...
    >>> from scipy_mlx.integrate import newton_cotes
    >>> import mlx.core as mx
    >>> def f(x):
    ...     return mx.sin(x)
    >>> a = 0
...
def qmc_quad(func, a, b, *, n_estimates=8, n_points=1024, qrng=None,
    ...
    >>> from scipy_mlx.integrate import qmc_quad
    >>> a = mx.zeros(dim)
    >>> b = mx.ones(dim)
