from scipy_mlx._lib._array_api import np_compat, array_namespace
...
class GaussKronrodQuadrature(NestedFixedRule):
    ...
    >>> from scipy_mlx.integrate._rules import GaussKronrodQuadrature
    >>> def f(x):
    ...     return mx.cos(x)
    ...
    >>> import mlx.core as mx
    >>> from scipy_mlx.integrate import cubature
    >>> from scipy_mlx.integrate._rules import (
