...
from scipy_mlx._lib._array_api import array_namespace, np_compat

from scipy_mlx.integrate._rules import NestedFixedRule
...
class GenzMalikCubature(NestedFixedRule):
    ...
    >>> from scipy_mlx.integrate import cubature
    >>> from scipy_mlx.integrate._rules import GenzMalikCubature
    >>> def f(x):
