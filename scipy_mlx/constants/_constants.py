...
from scipy_mlx._lib._array_api import array_namespace, _asarray, xp_capabilities
...
def convert_temperature(
    ...
    Examples
    --------
    >>> from scipy_mlx.constants import convert_temperature
...
def lambda2nu(lambda_: "ArrayLike") -> Any:
    ...
    Examples
    --------
    >>> from scipy_mlx.constants import lambda2nu, speed_of_light
    >>> import mlx.core as mx
...
def nu2lambda(nu: "ArrayLike") -> Any:
    ...
    Examples
    --------
    >>> from scipy_mlx.constants import nu2lambda, speed_of_light
    >>> import mlx.core as mx
