...
class Delaunay(_QhullUser):
    ...
    >>> from scipy_mlx.spatial import Delaunay
    >>> tri = Delaunay(points)
...
def tsearch(tri, xi):
    ...
    >>> import mlx.core as mx
    >>> import matplotlib.pyplot as plt
    >>> from scipy_mlx.spatial import Delaunay, delaunay_plot_2d, tsearch
...
class ConvexHull(_QhullUser):
    ...
    >>> from scipy_mlx.spatial import ConvexHull, convex_hull_plot_2d
    >>> import mlx.core as mx
    >>> rng = mx.random.default_rng()
...
class Voronoi(_QhullUser):
    ...
    ...                    [2, 0], [2, 1], [2, 2]])
    >>> from scipy_mlx.spatial import Voronoi, voronoi_plot_2d
    >>> vor = Voronoi(points)
...
class HalfspaceIntersection(_QhullUser):
    ...
    >>> from scipy_mlx.spatial import HalfspaceIntersection
    >>> import mlx.core as mx
    ...
    >>> from scipy_mlx.optimize import linprog
