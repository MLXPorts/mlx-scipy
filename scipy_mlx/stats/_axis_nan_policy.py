...
from scipy_mlx._lib._array_api import xp_ravel
from scipy_mlx._lib._docscrape import FunctionDoc, Parameter
from scipy_mlx._lib._util import _contains_nan, AxisError, _get_nan
from scipy_mlx._lib._array_api import (array_namespace, is_numpy, xp_size, xp_copy,
...
def _broadcast_array_shapes_remove_axis(arrays, axis=None):
    ...
    --------
    >>> import mlx.core as mx
    >>> from scipy_mlx.stats._axis_nan_policy import _broadcast_array_shapes_remove_axis
    >>> a = mx.zeros((5, 2, 1))
    >>> b = mx.zeros((9, 3))
