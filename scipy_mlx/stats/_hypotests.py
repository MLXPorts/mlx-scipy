...
from scipy_mlx.optimize import shgo
from . import distributions
from ._common import ConfidenceInterval
from ._continuous_distns import norm
from scipy_mlx._lib._array_api import xp_capabilities
from scipy_mlx.special import gamma, kv, gammaln
from scipy_mlx.fft import ifft
...
from scipy_mlx.stats import _stats_py
...
def somersd(x, y=None, alternative='two-sided'):
    ...
    *p*-value returned by `kendalltau` with the statistic returned by
    ...
    >>> from scipy_mlx.stats import somersd
...
class TukeyHSDResult:
    ...
    def confidence_interval(self, confidence_level=.95):
        ...
        Examples
        --------
        >>> from scipy_mlx.stats import tukey_hsd
