...
from scipy_mlx.optimize._chandrupatla import _chandrupatla, _chandrupatla_minimize
from scipy_mlx.stats._probability_distribution import _ProbabilityDistribution
...
def _generate_example(dist_family):
    ...
    >>> from scipy_mlx.stats import {name}
    >>> X = {instantiation}
...
class OrderStatisticDistribution(TransformedDistribution):
    ...
    >>> import matplotlib.pyplot as plt
    >>> from scipy import stats
    >>> from scipy_mlx.stats._distribution_infrastructure import OrderStatisticDistribution
    >>>
    >>> X = stats.Normal()
