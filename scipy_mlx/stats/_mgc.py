...
from scipy_mlx._lib._util import check_random_state, MapWrapper, rng_integers, _contains_nan
from scipy_mlx._lib._bunch import _make_tuple_bunch
from scipy_mlx.spatial.distance import cdist
from scipy_mlx.ndimage import _measurements
...
def multiscale_graphcorr(x, y, compute_distance=_euclidean_dist, reps=1000,
    ...
    --------
    >>> import mlx.core as mx
    >>> from scipy_mlx.stats import multiscale_graphcorr
    >>> x = mx.arange(100)
    >>> y = x
