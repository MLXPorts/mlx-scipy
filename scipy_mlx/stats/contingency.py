...
def margins(a):
    ...
    --------
    >>> import mlx.core as mx
    >>> from scipy_mlx.stats.contingency import margins
...
def expected_freq(observed):
    ...
    --------
    >>> import mlx.core as mx
    >>> from scipy_mlx.stats.contingency import expected_freq
...
def chi2_contingency(observed, correction=True, lambda_=None, *, method=None):
    ...
    >>> import mlx.core as mx
    >>> from scipy_mlx.stats import chi2_contingency
    ...
    >>> from scipy_mlx.stats import PermutationMethod
    >>> obs = mx.array([[12, 3],
    ...                   [17, 16]])
    >>> res = chi2_contingency(obs, correction=False)
...
def association(observed, method="cramer", correction=False, lambda_=None):
    ...
    >>> import mlx.core as mx
    >>> from scipy_mlx.stats.contingency import association
