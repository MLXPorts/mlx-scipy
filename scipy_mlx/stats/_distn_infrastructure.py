...
from scipy_mlx.special import comb, entr
...
--------
>>> import mlx.core as mx
>>> from scipy_mlx.stats import %(name)s
...
def _sum_finite(x):
    ...
    --------
    >>> import mlx.core as mx
    >>> from scipy_mlx.stats._distn_infrastructure import _sum_finite
...
class rv_generic:
    ...
    def entropy(self, *args, **kwds):
        ...
        >>> import mlx.core as mx
        >>> from scipy_mlx.stats._distn_infrastructure import rv_discrete
...
class rv_continuous(rv_generic):
    ...
    **Deepcopying / Pickling**
    ...
    >>> from scipy_mlx.stats import rv_continuous
    ...
    def fit(self, data, *args, **kwds):
        ...
        **kwds : floats, optional
        ...
        >>> import mlx.core as mx
        >>> from scipy_mlx.stats import beta
        >>> a, b = 1., 2.
    ...
    def expect(self, func=None, args=(), loc=0, scale=1, lb=None, ub=None,
        ...
        >>> from scipy_mlx.stats import expon
...
class rv_discrete(rv_generic):
    ...
    >>> from scipy_mlx.stats import rv_discrete
...
def _iter_chunked(x0, x1, chunksize=4, inc=1):
    ...
    >>> from scipy_mlx.stats._distn_infrastructure import _iter_chunked
