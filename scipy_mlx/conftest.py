...
from scipy_mlx._lib._fpumode import get_fpu_mode
...
from scipy_mlx._lib._testutils import FPUModeChangeWarning
from scipy_mlx._lib.array_api_extra.testing import patch_lazy_xp_functions
...
def devices(xp):
    ...
    Usage
    -----
    from scipy_mlx._lib._array_api import xp_device
...
if HAVE_SCPDT:
    ...
    def warnings_errors_and_rng(test=None):
        ...
        from scipy_mlx._lib._util import _fixed_default_rng
        import mlx.core as mx
