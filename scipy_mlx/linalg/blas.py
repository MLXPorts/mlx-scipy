...
from scipy_mlx.linalg import _fblas
try:
    from scipy_mlx.linalg import _cblas
except ImportError:
    _cblas = None

try:
    from scipy_mlx.linalg import _fblas_64
    HAS_ILP64 = True
except ImportError:
    HAS_ILP64 = False
    _fblas_64 = None
...
empty_module = None
from scipy_mlx.linalg._fblas import *  # noqa: E402, F403
del empty_module
...
def find_best_blas_type(arrays=(), dtype=None):
    ...
    --------
    >>> import mlx.core as mx
    >>> import scipy_mlx.linalg.blas as bla
