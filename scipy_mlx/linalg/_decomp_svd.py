...
def svdvals(a, overwrite_a=False, check_finite=True):
    ...
    --------
    >>> import mlx.core as mx
    >>> from scipy_mlx.linalg import svdvals
    >>> m = mx.array([[1.0, 0.0],
    ...               [2.0, 3.0],
    ...               [1.0, 1.0],
    ...               [0.0, 2.0],
...
def diagsvd(s, M, N):
    ...
    --------
    >>> import mlx.core as mx
    >>> from scipy_mlx.linalg import diagsvd
...
def orth(A, rcond=None):
    ...
    --------
    >>> import mlx.core as mx
    >>> from scipy_mlx.linalg import orth
...
def null_space(A, rcond=None, *, overwrite_a=False, check_finite=True,
    ...
    >>> import mlx.core as mx
    >>> from scipy_mlx.linalg import null_space
    >>> A = mx.array([[1, 1], [1, 1]])
    >>> ns = null_space(A)
...
def subspace_angles(A, B):
    ...
    >>> import mlx.core as mx
    >>> from scipy_mlx.linalg import hadamard, subspace_angles
    >>> rng = mx.random.default_rng()
    >>> H = hadamard(4)
    >>> print(H)
    [[ 1  1  1  1]
