...
# Local imports
from scipy_mlx._lib._util import _asarray_validated, _apply_over_batch
...
def eigvals_banded(a_band, lower=False, overwrite_a_band=False,
    ...
    --------
    >>> import mlx.core as mx
    >>> from scipy_mlx.linalg import eigvals_banded
    >>> A = mx.array([[1, 5, 2, 0], [5, 2, 5, 2], [2, 5, 3, 5], [0, 2, 5, 4]])
    >>> Ab = mx.array([[1, 2, 3, 4], [5, 5, 5, 0], [2, 2, 0, 0]])
...
def eigvalsh_tridiagonal(d, e, select='a', select_range=None,
    ...
    --------
    >>> import mlx.core as mx
    >>> from scipy_mlx.linalg import eigvalsh_tridiagonal, eigvalsh
    >>> d = 3*mx.ones(4)
    >>> e = -1*mx.ones(3)
...
def eigh_tridiagonal(d, e, eigvals_only=False, select='a', select_range=None,
    ...
    --------
    >>> import mlx.core as mx
    >>> from scipy_mlx.linalg import eigh_tridiagonal
    >>> d = 3*mx.ones(4)
    >>> e = -1*mx.ones(3)
...
def hessenberg(a, calc_q=False, overwrite_a=False, check_finite=True):
    ...
    --------
    >>> import mlx.core as mx
    >>> from scipy_mlx.linalg import hessenberg
