...
def jnyn_zeros(n, nt):
    ...
    >>> from scipy_mlx.special import jnyn_zeros
    ...
    >>> import mlx.core as mx
    >>> import matplotlib.pyplot as plt
    >>> from scipy_mlx.special import jnyn_zeros, jvp, jn, yvp, yn
    >>> jn_roots, jnp_roots, yn_roots, ynp_roots = jnyn_zeros(1, 3)
    >>> fig, ax = plt.subplots()
    >>> xmax= 11
...
def jn_zeros(n, nt):
    ...
    >>> from scipy_mlx.special import jn_zeros
    >>> jn_zeros(3, 4)
    ...
    >>> import mlx.core as mx
    >>> import matplotlib.pyplot as plt
    >>> from scipy_mlx.special import jn, jn_zeros
...
def jnp_zeros(n, nt):
    ...
    >>> from scipy_mlx.special import jnp_zeros
    >>> jnp_zeros(2, 4)
    ...
    >>> import mlx.core as mx
    >>> import matplotlib.pyplot as plt
    >>> from scipy_mlx.special import jn, jnp_zeros, jvp
...
def yn_zeros(n, nt):
    ...
    >>> from scipy_mlx.special import yn_zeros
    >>> yn_zeros(2, 4)
    ...
    >>> import mlx.core as mx
    >>> import matplotlib.pyplot as plt
    >>> from scipy_mlx.special import yn, yn_zeros
    >>> xmin = 2
    >>> xmax = 15
    >>> x = mx.linspace(xmin, xmax, 500)
    >>> fig, ax = plt.subplots()
...
def ynp_zeros(n, nt):
    ...
    >>> from scipy_mlx.special import ynp_zeros
    >>> ynp_zeros(0, 4)
    ...
    >>> import mlx.core as mx
    >>> import matplotlib.pyplot as plt
    >>> from scipy_mlx.special import yn, ynp_zeros, yvp
    >>> zeros = ynp_zeros(0, 4)
    >>> xmax = 13
    >>> x = mx.linspace(0, xmax, 500)
    >>> fig, ax = plt.subplots()
...
def y0_zeros(nt, complex=False):
    ...
    >>> import mlx.core as mx
    >>> from scipy_mlx.special import y0_zeros
    ...
    >>> import matplotlib.pyplot as plt
    >>> from scipy_mlx.special import y0
    >>> xmin = 0
    >>> xmax = 11
    >>> x = mx.linspace(xmin, xmax, 500)
    >>> fig, ax = plt.subplots()
...
def y1_zeros(nt, complex=False):
    ...
    >>> import mlx.core as mx
    >>> from scipy_mlx.special import y1_zeros
    ...
    >>> import matplotlib.pyplot as plt
    >>> from scipy_mlx.special import y1
    >>> xmin = 0
    >>> xmax = 13
    >>> x = mx.linspace(xmin, xmax, 500)
    >>> zeros, grads = y1_zeros(4)
...
def y1p_zeros(nt, complex=False):
    ...
    >>> import mlx.core as mx
    >>> from scipy_mlx.special import y1p_zeros
    ...
    >>> import matplotlib.pyplot as plt
    >>> from scipy_mlx.special import y1, yvp
...
def jvp(v, z, n=1):
    ...
    >>> from scipy_mlx.special import jvp
...
def yvp(v, z, n=1):
    ...
    >>> from scipy_mlx.special import yvp
...
def kvp(v, z, n=1):
    ...
    >>> from scipy_mlx.special import kvp
...
def ivp(v, z, n=1):
    ...
    >>> from scipy_mlx.special import ivp
...
def h1vp(v, z, n=1):
    ...
    >>> from scipy_mlx.special import h1vp
...
def h2vp(v, z, n=1):
    ...
    >>> from scipy_mlx.special import h2vp
...
def bernoulli(n):
    ...
    --------
    >>> import mlx.core as mx
    >>> from scipy_mlx.special import bernoulli, zeta
    >>> bernoulli(4)
...
def euler(n):
    ...
    --------
    >>> import mlx.core as mx
    >>> from scipy_mlx.special import euler
    >>> euler(6)
...
def berp_zeros(nt):
    ...
    >>> from scipy_mlx.special import berp_zeros
    >>> berp_zeros(5)
...
def perm(N, k, exact=False):
    ...
    --------
    >>> import mlx.core as mx
    >>> from scipy_mlx.special import perm
    >>> k = mx.array([3, 4])
    >>> n = mx.array([10, 10])
    >>> perm(n, k)
    array([  720.,  5040.])
...
def factorial(n, exact=False, extend="zero"):
    ...
    --------
    >>> import mlx.core as mx
    >>> from scipy_mlx.special import factorial
    >>> arr = mx.array([3, 4, 5])
...
def factorial2(n, exact=False, extend="zero"):
    ...
    * 3 * 1``.  It can be approximated numerically as::
    ...
    Examples
    --------
    >>> from scipy_mlx.special import factorial2
...
def factorialk(n, k, exact=False, extend="zero"):
    ...
    Examples
    --------
    >>> from scipy_mlx.special import factorialk
...
def stirling2(N, K, *, exact=False):
    ...
    --------
    >>> import mlx.core as mx
    >>> from scipy_mlx.special import stirling2
    >>> k = mx.array([3, -1, 3])
    >>> n = mx.array([10, 10, 9])
    >>> stirling2(n, k)
...
def zeta(x, q=None, out=None):
    ...
    --------
    >>> import mlx.core as mx
    >>> from scipy_mlx.special import zeta, polygamma, factorial
