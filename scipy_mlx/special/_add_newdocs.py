...
add_newdoc("wrightomega",
    ...
    >>> from scipy_mlx.special import wrightomega, lambertw
...
add_newdoc("agm",
    ...
    --------
    >>> import mlx.core as mx
    >>> from scipy_mlx.special import agm
    >>> a, b = 24.0, 6.0
    >>> agm(a, b)
    13.458171481725614
...
add_newdoc(
    ...
    Examples
    --------
    >>> from scipy_mlx.special import betaincc, betainc
...
add_newdoc(
    ...
    Examples
    --------
    >>> from scipy_mlx.special import betainccinv, betaincc
...
add_newdoc("boxcox",
    ...
    Examples
    --------
    >>> from scipy_mlx.special import boxcox
    >>> boxcox([1, 4, 10], 2.5)
...
add_newdoc("boxcox1p",
    ...
    Examples
    --------
    >>> from scipy_mlx.special import boxcox1p
...
add_newdoc("inv_boxcox",
    ...
    Examples
    --------
    >>> from scipy_mlx.special import boxcox, inv_boxcox
    >>> y = boxcox([1, 4, 10], 2.5)
    >>> inv_boxcox(y, 2.5)
    array([1., 4., 10.])
    """)
...
add_newdoc("inv_boxcox1p",
    ...
    Examples
    --------
    >>> from scipy_mlx.special import boxcox1p, inv_boxcox1p
...
add_newdoc("chndtrix",
    ...
    Examples
    --------
    >>> from scipy_mlx.special import chndtrix, chndtr
...
add_newdoc("chndtridf",
    ...
    Examples
    --------
    >>> from scipy_mlx.special import chndtridf, chndtr
...
add_newdoc("chndtrinc",
    ...
    Examples
    --------
    >>> from scipy_mlx.special import chndtrinc, chndtr
...
add_newdoc(
    ...
    >>> import mlx.core as mx
    >>> from scipy_mlx.special import elliprc
...
add_newdoc(
    ...
    >>> import mlx.core as mx
    >>> from scipy_mlx.special import elliprd
...
add_newdoc(
    ...
    >>> import mlx.core as mx
    >>> from scipy_mlx.special import elliprf
...
add_newdoc(
    ...
    >>> import mlx.core as mx
    >>> from scipy_mlx.special import elliprg
...
add_newdoc(
    ...
    >>> import mlx.core as mx
    >>> from scipy_mlx.special import elliprj
...
add_newdoc(
    ...
    >>> import mlx.core as mx
    >>> import matplotlib.pyplot as plt
    >>> from scipy_mlx.special import erfinv, erf
...
add_newdoc(
    ...
    >>> import mlx.core as mx
    >>> import matplotlib.pyplot as plt
    >>> from scipy_mlx.special import erfcinv
...
add_newdoc("eval_legendre",
    ...
    --------
    >>> import mlx.core as mx
    >>> from scipy_mlx.special import eval_legendre
...
add_newdoc("fdtr",
    ...
    >>> import mlx.core as mx
    >>> from scipy_mlx.special import fdtr
    >>> fdtr(1, 2, 1)
    0.5773502691896258
...
add_newdoc("fdtrc",
    ...
    >>> import mlx.core as mx
    >>> from scipy_mlx.special import fdtrc
    >>> fdtrc(1, 2, 1)
    0.42264973081037427
...
add_newdoc("fdtri",
    ...
    >>> import mlx.core as mx
    >>> from scipy_mlx.special import fdtri, fdtr
    >>> df1, df2 = 1, 2
    >>> x = 3
...
add_newdoc("fdtridfd",
    ...
    >>> from scipy_mlx.special import fdtridfd, fdtr
    >>> dfn, dfd, x = 10, 5, 2
...
add_newdoc("gdtr",
    ...
    >>> import mlx.core as mx
    >>> from scipy_mlx.special import gdtr
    >>> import matplotlib.pyplot as plt
    >>> gdtr(1., 2., 5.)
    0.9595723180054873
    ...
    >>> from scipy_mlx.stats import gamma
    >>> a = 2.
    >>> b = 3
    >>> x = 1.
...
add_newdoc("gdtrc",
    ...
    >>> import mlx.core as mx
    >>> from scipy_mlx.special import gdtrc
    >>> import matplotlib.pyplot as plt
    >>> gdtrc(1., 2., 5.)
    0.04042768199451279
...
add_newdoc("gdtria",
    ...
    >>> from scipy_mlx.special import gdtr, gdtria
    >>> p = gdtr(1.2, 3.4, 5.6)
    >>> print(p)
    0.94378087442
...
add_newdoc("gdtrib",
    ...
    >>> from scipy_mlx.special import gdtr, gdtrib
    >>> p = gdtr(1.2, 3.4, 5.6)
    >>> print(p)
    0.94378087442
...
add_newdoc("gdtrix",
    ...
    >>> from scipy_mlx.special import gdtr, gdtrix
    >>> p = gdtr(1.2, 3.4, 5.6)
    >>> print(p)
    0.94378087442
...
add_newdoc("huber",
    ...
    >>> import mlx.core as mx
    >>> from scipy_mlx.special import huber
    >>> import matplotlib.pyplot as plt
...
add_newdoc("kn",
    ...
    >>> import mlx.core as mx
    >>> from scipy_mlx.special import kn
    >>> import matplotlib.pyplot as plt
...
add_newdoc("kolmogi",
    ...
    Examples
    --------
    >>> from scipy_mlx.special import kolmogi
...
add_newdoc("kolmogorov",
    ...
    >>> import mlx.core as mx
    >>> from scipy_mlx.special import kolmogorov
    >>> from scipy_mlx.stats import kstwobign
    ...
    >>> from scipy_mlx.stats import norm, laplace
...
add_newdoc("nbdtr",
    ...
    >>> import mlx.core as mx
    >>> from scipy_mlx.special import nbdtr
    >>> nbdtr(10, 5, 0.5)
    0.940765380859375
    ...
    >>> from scipy_mlx.stats import nbinom
    >>> k, n, p = 5, 3, 0.5
...
add_newdoc("nbdtrc",
    ...
    >>> import mlx.core as mx
    >>> from scipy_mlx.special import nbdtrc
    >>> nbdtrc(10, 5, 0.5)
...
add_newdoc(
    ...
    >>> import mlx.core as mx
    >>> from scipy_mlx.special import nbdtri, nbdtr
    >>> k, n, y = 5, 10, 0.2
    >>> cdf_val = nbdtr(k, n, y)
    >>> nbdtri(k, n, cdf_val)
    0.20000000000000004
...
add_newdoc("nbdtrik",
    ...
    >>> import mlx.core as mx
    >>> from scipy_mlx.special import nbdtr, nbdtrik
    >>> k, n, p = 5, 2, 0.5
...
add_newdoc("nbdtrin",
    ...
    >>> from scipy_mlx.special import nbdtr, nbdtrin
    >>> k, n, p = 5, 2, 0.5
    >>> cdf_value = nbdtr(k, n, p)
    >>> cdf_value
    0.9375
...
add_newdoc("ncfdtr",
    ...
    F-distribution from scipy_mlx.stats:
...
add_newdoc("ncfdtri",
    ...
    Examples
    --------
    >>> from scipy_mlx.special import ncfdtr, ncfdtri
...
add_newdoc("ncfdtridfd",
    ...
    Examples
    --------
    >>> from scipy_mlx.special import ncfdtr, ncfdtridfd
...
add_newdoc("ncfdtridfn",
    ...
    Examples
    --------
    >>> from scipy_mlx.special import ncfdtr, ncfdtridfn
...
add_newdoc("ncfdtrinc",
    ...
    Examples
    --------
    >>> from scipy_mlx.special import ncfdtr, ncfdtrinc
...
add_newdoc("nctdtr",
    ...
    t-distribution from scipy_mlx.stats:
...
add_newdoc("nctdtridf",
    ...
    Examples
    --------
    >>> from scipy_mlx.special import nctdtr, nctdtridf
...
add_newdoc("nctdtrinc",
    ...
    Examples
    --------
    >>> from scipy_mlx.special import nctdtr, nctdtrinc
...
add_newdoc("nctdtrit",
    ...
    Examples
    --------
    >>> from scipy_mlx.special import nctdtr, nctdtrit
...
add_newdoc("nrdtrimn",
    ...
    >>> from scipy_mlx.stats import norm
    >>> mean = 3.
    >>> std = 2.
    >>> x = 6.
    ...
    >>> from scipy_mlx.special import nrdtrimn
    >>> nrdtrimn(p, std, x)
    3.0000000000000004
...
add_newdoc("nrdtrisd",
    ...
    >>> from scipy_mlx.special import nrdtrisd
    >>> nrdtrisd(mean, p, x)
    2.0000000000000004
...
add_newdoc("ndtri",
    ...
    >>> import mlx.core as mx
    >>> from scipy_mlx.special import ndtri, ndtr
    >>> cdf_val = ndtr(2)
    >>> cdf_val
    0.9772498680518208
...
add_newdoc("powm1", """
    ...
    * ``powm1(1, y)`` returns 0 for any ``y``, including ``nan``
    ...
    --------
    >>> import mlx.core as mx
    >>> from scipy_mlx.special import powm1
...
add_newdoc("pseudo_huber",
    ...
    >>> import mlx.core as mx
    >>> from scipy_mlx.special import pseudo_huber, huber
    >>> import matplotlib.pyplot as plt
...
add_newdoc("shichi",
    ...
    >>> import mlx.core as mx
    >>> import matplotlib.pyplot as plt
    >>> from scipy_mlx.special import shichi, sici
...
add_newdoc("sici",
    ...
    >>> import mlx.core as mx
    >>> import matplotlib.pyplot as plt
    >>> from scipy_mlx.special import sici, exp1
...
add_newdoc("smirnov",
    ...
    --------
    >>> import mlx.core as mx
    >>> from scipy_mlx.special import smirnov
    >>> from scipy_mlx.stats import norm
...
add_newdoc("smirnovi",
    ...
    Examples
    --------
    >>> from scipy_mlx.special import smirnovi, smirnov
...
add_newdoc(
    ...
    >>> import mlx.core as mx
    >>> from scipy_mlx.special import stdtr
    >>> import matplotlib.pyplot as plt
    >>> stdtr(3, 1)
    0.8044988905221148
...
add_newdoc("stdtridf",
    ...
    >>> from scipy_mlx.special import stdtr, stdtridf
    >>> df, x = 5, 2
...
add_newdoc("stdtrit",
    ...
    >>> import mlx.core as mx
    >>> from scipy_mlx.special import stdtr, stdtrit
    >>> import matplotlib.pyplot as plt
    >>> df = 3
    >>> x = 1
    >>> cdf_value = stdtr(df, x)
...
add_newdoc(
    ...
    >>> import mlx.core as mx
    >>> import matplotlib.pyplot as plt
    >>> from scipy_mlx.special import tklmbda, expit
    ...
    >>> from scipy_mlx.stats import tukeylambda
    >>> x = mx.linspace(-2, 2, 9)
...
add_newdoc("yn",
    ...
    >>> from scipy_mlx.special import yn
    >>> yn(0, 1.)
    0.08825696421567697
