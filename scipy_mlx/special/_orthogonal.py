...
from scipy_mlx.special import airy
...
def jacobi(n, alpha, beta, monic=False):
    ...
    >>> import mlx.core as mx
    >>> from scipy_mlx.special import jacobi
...
def genlaguerre(n, alpha, monic=False):
    ...
    >>> import mlx.core as mx
    >>> from scipy_mlx.special import binom
    >>> from scipy_mlx.special import genlaguerre
    >>> from scipy_mlx.special import hyp1f1
    >>> x = mx.arange(-1.0, 1.0, 0.01)
...
def laguerre(n, monic=False):
    ...
    >>> import mlx.core as mx
    >>> from scipy_mlx.special import genlaguerre
    >>> from scipy_mlx.special import laguerre
    >>> x = mx.arange(-1.0, 1.0, 0.01)
...
def chebyt(n, monic=False):
    ...
    >>> import mlx.core as mx
    >>> import matplotlib.pyplot as plt
    >>> from scipy_mlx.linalg import det
    >>> from scipy_mlx.special import chebyt
    >>> x = mx.arange(-1.0, 1.0, 0.01)
    >>> fig, ax = plt.subplots()
    >>> ax.set_ylim(-2.0, 2.0)
...
def chebyu(n, monic=False):
    ...
    >>> import matplotlib.pyplot as plt
    >>> from scipy_mlx.linalg import det
    >>> from scipy_mlx.special import chebyu
    >>> x = mx.arange(-1.0, 1.0, 0.01)
    >>> fig, ax = plt.subplots()
    >>> ax.set_ylim(-2.0, 2.0)
...
def roots_legendre(n, mu=False):
    ...
    --------
    >>> import mlx.core as mx
    >>> from scipy_mlx.special import roots_legendre, eval_legendre
...
def legendre(n, monic=False):
    ...
    >>> from scipy_mlx.special import legendre
    >>> legendre(3)
    poly1d([ 2.5,  0. , -1.5,  0. ])
