...
def loadmat(file_name, mdict=None, appendmat=True, *, spmatrix=True, **kwargs):
    ...
    if spmatrix:
        from scipy_mlx.sparse import issparse, coo_matrix, csc_matrix
...
def savemat(file_name, mdict,
    ...
    Examples
    --------
    >>> from scipy_mlx.io import savemat
...
def whosmat(file_name, appendmat=True, **kwargs):
    ...
    >>> import mlx.core as mx
    >>> from scipy_mlx.io import savemat, whosmat
